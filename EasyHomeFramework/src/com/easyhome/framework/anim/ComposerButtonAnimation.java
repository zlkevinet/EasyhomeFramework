package com.easyhome.framework.anim;
...
import com.easyhome.framework.view.plusmenu.InOutImageButton;
...
public class ComposerButtonAnimation extends InOutAnimation
{
    ...
    protected void addInAnimation(View aview[])
    {
        ...
        float fromY = marginlayoutparams.bottomMargin - yOffset;
    ...
    protected void addOutAnimation(View aview[])
    {
        ...
        float toY = marginlayoutparams.bottomMargin - yOffset;
